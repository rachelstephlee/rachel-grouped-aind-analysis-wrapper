...
class SummaryPlotsAnalysisOutputs(GenericModel):
    """
    Output parameters for the summary plots analysis.
 
    This analysis only produces plots/files on disk (no scalar outputs
    tracked in DocDB yet), so this model is intentionally empty. Add
    fields here if you want specific results tracked in the processing
    record's output_parameters.
    """
